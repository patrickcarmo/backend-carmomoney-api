...
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Fulano Pereira', 'Rua Napoli', '10', null, 'Brasil', '74.280-155', 'Goiânia', 'GO', true);
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Neusa Maria', 'Rua Doutor Werneck', 'SN', null, 'Brasil', '79.060-300', 'Campo Grande', 'MS', true);
